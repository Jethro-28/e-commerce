...
onMounted(() => {
    stripe = Stripe("pk_test_51NID87ITGjvphkn2LGpi6FHzRPIfjOcQZNH2feDf9FY3WP3FeOJmAK7Vd1sqy0gq66RVsbljQ6E2u4e79AIzrLRl00pJ6eughu");
            ...
            <div class="w-4/12 border border-gray-400 rounded-md py-4 px-2">
                <form id="payment-form">
                    ...
                    <div class="flex justify-between text-xl text-red-700 font-extrabold border-y border-y-gray-300 my-3 p-2">
                        <div>Order total:</div>
                        <div v-if="order">PHP: {{ order.total_decimal }}</div>
                    </div>
                    ...
                    <button id="submit"
                        ...
                        <div v-else id="button-text">Place your order in PHP</div>
                    </button>
