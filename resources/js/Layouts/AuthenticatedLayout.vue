...
<template>
    <div class="min-w-[1000px] bg-gray-100 h-full"> 
        ...
        <div class="flex items-center bg-gray-900 h-[60px] py-2 fixed z-50 min-w-[1150px] w-full">
            ...
            <div class="flex">
                <Link :href="route('dashboard')" class="text-white h-[50px] p-2 pt-3 border-[1px] border-gray-900 rounded-sm hover:border-[1px] hover:border-gray-100 cursor-pointer">
                    <img width="100" src="/images/logo/e-commerce.png">
                </Link>
            </div>
                    ...
                    <div v-for="product in $page.props.random_products" :key="product">
                        <div class="p-4 text-center mx-auto">
                            ...
                            <div class="flex justify-start">
                                ...
                                <img width="50" src="/images/logo/e-commerce.png" alt="">
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <footer >
            <div class="bg-neutral-200 p-4 text-center text-neutral-700 dark:bg-neutral-700 dark:text-neutral-200">
                © 2023 Copyright @
                <a class="text-neutral-800 dark:text-neutral-400" :href="route('dashboard')"  >E-Commerce</a>
            </div>
        </footer>
