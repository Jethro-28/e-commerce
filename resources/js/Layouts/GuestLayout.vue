...
<template>
    <div class="min-h-screen flex flex-col items-center pt-6">
        <div>
            <Link href="/">
                <img class="h-12 fill-current text-gray-500" src="/images/logo/e-commerce.png" alt="">
            </Link>
        </div>
        ...
        <div v-if="$page.url === '/login'" class="w-[400px]">
            <div class="text-center text-sm text-gray-600 font-bold py-4">New to E-commerce?</div>
